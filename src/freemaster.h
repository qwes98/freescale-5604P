...
* @file   freemaster.h
*
* @brief  FreeMASTER Driver main API header file, MPC56xx platform
*
* @version 1.0.5.0
* 
* @date Aug-10-2011
...
typedef signed long    FMSTR_BOOL;   /* general boolean type  */
...
void FMSTR_Isr(void);          /* SCI/FlexCAN interrupt handler for LONG_INTR and SHORT_INTR modes */
