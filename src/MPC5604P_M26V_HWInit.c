...
/*
 *
 * FILE : MPC5604P_M26V_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5604P_M26V derivative needed initializations, 
 *  and all initializations for the MPC5604P_M26V boards which are supported.
...
#include "MPC5604P_M26V.h"        /* MPC55xx platform development header            */
#include "MPC5604P_M26V_HWInit.h"
...
/*******************************************************/
/* MPC5604P_M26V derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5604P_M26V. 
*/
...
/*******************************************************/
/* MPC5604P_M26V boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5604P_M26VDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5604P_M26VDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5604P_M26V external bus
        Set up the pins
